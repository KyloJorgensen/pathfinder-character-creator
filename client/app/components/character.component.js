			    		...
			    		<div id="banner">
				    		<div className="container">
				    			<div className="character-menu">
					    			<div>
					    				<p className="sample">This is a sample character sheet to save and to have all of the features available please sign up or sign in.</p>
						    			<h1>Character</h1>
						    			<h2>{this.state.name} - {this.state.race} {this.state.class} {this.state.level} </h2>
